...
switch-theme() {
    ...
    if [ "$1" = "-h" ] || [ "$1" = "--help" ]; then
        ...
        echo ""
        echo -e "\e[1mUsage:\e[0m \e[92mswitch-theme command\e[0m"
        echo -e "\e[92m#\e[0m               - Change theme to a specific index, i.e. > \e[92mswitch-theme 3\e[0m"
        echo -e "\e[92m-r --random\e[0m     - Change to a random theme specified in your switch-theme.zsh"
        echo -e "\e[92m-l --list\e[0m       - List all available themes with their specific index"
        echo ""
        echo "To add a theme, edit switch-theme.zsh and add your theme to a new line under theme_names & theme_files"
        return
    fi
    ...
    if [ "$1" = "-r" ] || [ "$1" = "--random" ]; then
        ...
        echo "Usage:" 
        echo "'\e[92mswitch-theme index\e[0m'"
        echo "'\e[92mswitch-theme --help\e[0m'"
        echo "'\e[92mswitch-theme --list\e[0m'"
        echo "'\e[92mswitch-theme --random\e[0m'"
        return
    fi
