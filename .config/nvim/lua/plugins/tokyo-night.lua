  ...
  config = function()
    require("tokyonight").setup({
      ...
      on_highlights = function(hl, c)
        ...
        -- set colors -- borderless telescope
        hl.TelescopeNormal = { bg = dark, fg = fg, }
        hl.TelescopeBorder = { bg = dark, fg = dark, }
        hl.TelescopePromptNormal = { bg = dark, }
        hl.TelescopePromptBorder = { bg = dark, fg = dark, }
        hl.TelescopePromptTitle = { bg = purple, fg = dark, }
        hl.TelescopePreviewTitle = { bg = blue, fg = dark, }
        hl.TelescopeResultsTitle = { bg = blue, fg = dark, }
